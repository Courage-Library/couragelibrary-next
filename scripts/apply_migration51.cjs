...
async function applyMigration() {
  ...
  const sqlPath = path.join(__dirname, '..', 'supabase', 'migrations', '20260910000051_phase5e6_psychometrics_foundation.sql');
  const sql = fs.readFileSync(sqlPath, 'utf-8');

  console.log('Applying Migration 51: phase5e6_psychometrics_foundation.sql...');
